...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'function.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'function.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'function.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "function.js.mem" : null;
...
var real__Verifica_Matricula = asm["_Verifica_Matricula"]; asm["_Verifica_Matricula"] = function() {
assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
return real__Verifica_Matricula.apply(null, arguments);
};
...
var real__Verifica_Matricula_milhao = asm["_Verifica_Matricula_milhao"]; asm["_Verifica_Matricula_milhao"] = function() {
assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
return real__Verifica_Matricula_milhao.apply(null, arguments);
};
...
var _Verifica_Matricula = Module["_Verifica_Matricula"] = function() { return Module["asm"]["_Verifica_Matricula"].apply(null, arguments) };
var stackRestore = Module["stackRestore"] = function() { return Module["asm"]["stackRestore"].apply(null, arguments) };
var _Verifica_Matricula_milhao = Module["_Verifica_Matricula_milhao"] = function() { return Module["asm"]["_Verifica_Matricula_milhao"].apply(null, arguments) };
